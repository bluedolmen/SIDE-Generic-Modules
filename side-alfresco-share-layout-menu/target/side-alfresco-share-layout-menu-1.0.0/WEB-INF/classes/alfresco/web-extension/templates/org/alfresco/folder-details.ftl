...
<@templateHeader>
   ...
   <@script type="text/javascript" src="${url.context}/res/js/side/combo.js"></@script>
   ...
   <#else>
      <div class="yui-g">
         <div class="yui-g first">
			...
			<div id="template_x002e_path_x002e_folder-details-iconType" class="icon-type">
				<img width="48" height="48" src="/share/res/components/documentlibrary/images/folder-48.png">
