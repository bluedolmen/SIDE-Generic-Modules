...
var DTP = DTP || {
	...
	/* Should be in the inherited class */
	...
	*/
	datatableEvents: function(){
		...
		this.editorSaveEvent = function(oArgs) {
			RequisitionDT.computeTotal(oArgs, this);
		}
...
function Consumer(name, obj) {
    this.obj = obj;
    this.obj.dataReady.subscribe(this.onDataReady, this);
}

Consumer.prototype.onDataReady = function(type, args, me) {
...
var c1 = new Consumer("mytestconsumer1", RequisitionDT);
